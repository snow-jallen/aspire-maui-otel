...
var apiService = builder.AddProject<Projects.PublicOtel_ApiService>("apiservice")
    .WithHttpHealthCheck("/health");

builder.AddProject<Projects.PublicOtel_Web>("webfrontend")
...
var mobileApiTunnel = builder.AddDevTunnel("mobile-api", tunnelId: "mobile-api-106279")
    .WithAnonymousAccess()
